...
Original file is located at
    https://colab.research.google.com/drive/1U7vNU_3mrIpHk_iyHDrTOmdogSkqLF7c
"""
...
def randomCentroids(k):
  ...
  return centroids
#notice clusters is simply a list
...
def llyod(k,clusters):
  ...
  plt.xlabel("Dimension 1")
  plt.ylabel("Dimension 2")
  plt.title("After K Means Clustering for k="+str(k)+" Fixed Initialization")
  plt.show()
  #vornoi regions
  for i in range(k):
...
#preprocessing
#generating fixed clusters
clustersFixed=randomCentroids(5)
...
for i in range(4):
  clusters=[]
  for j in range(k[i]):
    clusters.append(clustersFixed[j])
  llyod(k[i],clusters)