...
Original file is located at
    https://colab.research.google.com/drive/1vm4PG6qTCB4SSYAUoC1U-d3Sn4MVl66C
"""
...
#compute the kernelmatrix
k_mat=computeKernel(df,dft,n,m)
k_mat=kernelCenter(k_mat,n,m)
k_mat=computeEigen(k_mat,k)
k_mat=normalizeEv(k_mat)
temp=np.copy(df)
df=k_mat
n=df.shape[0]
m=df.shape[1]
clusters=randomCentroids(k,df,n,m)
z=assign(df,clusters,k,n,m)
meu=calculateMean(z,clusters,k,df,n,m)
e=0
e=e+computeErrors(meu,z,df,n,m)
err.append(e)
r,znew=reassign(z,meu,k,df,n,m)
z=np.copy(znew)
meu=calculateMean(z,clusters,k,df,n,m)
e=0
e=e+computeErrors(meu,z,df,n,m)
...
plt.xlabel("Dimension 1")
plt.ylabel("Dimension 2")
plt.title("After K Means Clustering Polynomial d=3")
plt.show()
